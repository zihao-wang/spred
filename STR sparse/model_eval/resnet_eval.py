...
from model_eval.builder_eval import get_builder
...
# ResNet }}}
def ResNet18(pretrained=False, num_classes=10, conv_type='VanillaConv'):
    # TODO: pretrained
    return ResNet(get_builder(conv_type), BasicBlock, [2, 2, 2, 2], num_classes)
