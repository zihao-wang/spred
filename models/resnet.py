...
class BasicBlock(_nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv2 = _nn.Conv2d(planes, planes, kernel_size=3,
        ...
        if stride != 1 or in_planes != self.expansion*planes:
            self.shortcut = _nn.Sequential(
                _nn.Conv2d(in_planes, self.expansion*planes,
...
class Bottleneck(_nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.bn2 = _nn.BatchNorm2d(planes)
        self.conv3 = _nn.Conv2d(planes, self.expansion *
...
class ResNet(_nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = _nn.Conv2d(3, 64, kernel_size=3,
                               stride=1, padding=1, bias=False)
